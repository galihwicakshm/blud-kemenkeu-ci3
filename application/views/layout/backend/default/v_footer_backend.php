 ...
 <!-- Vendors JS -->
 <script src="<?= base_url() ?>template-admin/assets/vendor/libs/apex-charts/apexcharts.js"></script>

 <!-- Main JS -->
 <script src="<?= base_url() ?>template-admin/assets/js/main.js"></script>

 <!-- Page JS -->
 <script src="<?= base_url() ?>template-admin/assets/js/dashboards-analytics.js"></script>
